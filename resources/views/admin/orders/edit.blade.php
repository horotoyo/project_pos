                  ...
                  <div id="product-box1">
                    <div class="col-md-4">
                      <div class="form-group">
                        <select name="product_name[]" class="form-control select2" style="width: 100%;" v-model="order.product_name">
                          <option selected="selected" value="">Product name @{{ index + 1 }}</option>
